...
values (1, 1, 'nguyen van a', 30000000, 1, 1, 1),
       (2, 2, 'nguyen van b', 40000000, 2, 2, 2),
       (3, 3, 'nguyen van c', 50000000, 3, 3, 3),
       (4, 4, 'nguyen van d', 60000000, 4, 4, 4);
-- buoc 3
...
select *
from products
where productname = 'nguyen van a'
   or productname = 'nguyen van b';
...
from products;
select s.*
from myviewproducts s;
create
or replace view view_of_me as
select productcode,
       productname
from myviewproducts;
select *
...
delimiter
//
create procedure addnew(in id int, productcode int, productname varchar (30), productprice double,
                        productamount varchar (30), productdescription varchar (30), productstatus varchar (30))
begin
insert into products
...
delimiter
//
create procedure fix(in id int, productcode int, productname varchar (30), productprice double,
                     productamount varchar (30), productdescription varchar (30), productstatus varchar (30))
begin
update products s
set s.id=id,
