...
select  s.studentid as idsinhvien,s.studentname as tensinhvien,s.address as diachinhasinhvien,s.phone as sodienthoaicuasinhvien,s.status ,avg(m.mark) as diemtrungbinh
